...
setwd("G:/My Drive/Manuscripts/Vallebueno_2022_UME/Figures/Dist_cov_allsamp")
...
geom_point(aes(color = dataF$V1), alpha=trsp)+
  geom_smooth(method = "lm", fill = NA, se=FALSE,formula = my.formula,size=0.9)+
...
FIG1<-plot_grid(px,pmds,p1,p2,label_size = 20,labels = 'AUTO', hjust = 0, vjust = 1, scale= 0.97)
FIG1
pdf("Vallebueno2022_Fig_1.pdf",width=6.69,height = 6.5)
FIG1
dev.off()
