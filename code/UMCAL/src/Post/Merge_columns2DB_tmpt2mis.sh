...
F=/groups/swarts/lab/Resources/Maize/WGS/mpileup/in_prod_mpileup_files.lst
KEY=${F}.tlone
Head=${F}.hh.gz
WDIR=/scratch-cbe/users/miguel.vallebueno/Production/${DST}
K=/scratch-cbe/users/miguel.vallebueno/Production/${DST}/Discovery_LL.ALLC.${DST}.ll
#K=/scratch-cbe/users/miguel.vallebueno/Production/${DST}/ZeaGBSv27_publicSamples_raw_AGPv5_crossmap.ll
