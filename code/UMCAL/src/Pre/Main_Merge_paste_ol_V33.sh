...
IDIR="/groups/swarts/lab/Resources/Maize/WGS/gVCFS/ALL"
WDIR="/scratch-cbe/users/miguel.vallebueno/MERGE"
KEY="/groups/swarts/lab/Resources/Maize/WGS/gVCFS/ALL/files.mergein_Discovery_2023_05.lst"
...
perl $caronte/Modules/Hidra-Heracles/DB2mono_poli_V3.pl /groups/swarts/lab/Resources/ReferenceGenomes/Zm-B73-REFERENCE-NAM-5.0.fa.OL ${WDIR}/All.tlone.Merge.db /groups/swarts/lab/Resources/ReferenceGenomes/Zm-B73-REFERENCE-NAM-5.0.bed $KEY.tlone
