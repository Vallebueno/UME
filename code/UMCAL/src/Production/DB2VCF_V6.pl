...
$file="/scratch-cbe/users/miguel.vallebueno/mpilp2db/mpileups.lst.mpileup.db";
$list="/scratch-cbe/users/miguel.vallebueno/mpilp2db/Maize_GBS_Kriztian_build.lst";
