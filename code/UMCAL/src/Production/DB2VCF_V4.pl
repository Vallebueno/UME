$file="/scratch-cbe/users/miguel.vallebueno/ALL/Test1_.ALL.Merge.10.poli.Union.db";
...
##fileDate=$datestring
##reference=file:////groups/swarts/lab/Resources/ReferenceGenomes/Zm-B73-REFERENCE-NAM-5.0.fa
