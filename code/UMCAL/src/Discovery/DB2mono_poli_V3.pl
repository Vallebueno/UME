...
$bed="/groups/swarts/lab/MAVE/Experiments/Hydra_coverage/OL/Zm-B73-REFERENCE-NAM-5.0.chr7.bed";
$ref="/groups/swarts/lab/Resources/ReferenceGenomes/Zm-B73-REFERENCE-NAM-5.0.fa.OL";
#$file="/scratch-cbe/users/miguel.vallebueno/ALL2/1.ALL.Merge.db.gz.head";
#$file="/scratch-cbe/users/miguel.vallebueno/ALL3/1.ALL.Merge.db.gz";
#$file="/scratch-cbe/users/miguel.vallebueno/ALL3/SUBSET_1.ALL.Merge.db";
$file="/groups/swarts/lab/MAVE/Experiments/Hydra_coverage/OL/files.mergein3.lst.tlone.Merge.db";

#$list="/scratch-cbe/users/miguel.vallebueno/ALL3/vcf_tmptx.lst.tlone";
...
while($line=<DB>) {
	...
	if($chr ne $achr){
		...
		#system ("sbatch /groups/swarts/lab/Resources/Scripts/Caronte/code/Modules/RAND/GZIPER.sh $out");
		#system ("sbatch /groups/swarts/lab/Resources/Scripts/Caronte/code/Modules/RAND/GZIPER.sh $outm");
