...
KEY=/path/to/workdir/Production/files_mp.lst.tlone
line=$(sed -n "$SLURM_ARRAY_TASK_ID"p ${KEY})
K=$2
K="Discovery_2023_08_cof10_ALLC.ll"
#Head="/path/to/workdir/Prod_cofs_test/in_prod_mpileup_files.lst.hh.gz"
Head="/path/to/workdir/Production/files_mp.lst.hh.gz"
...
#first="/path/to/workdir/MERGE/build06_2023.sort.ll"
#second="/path/to/workdir/Production/${K}"
