...
$file = "/path/to/project_inputs/files.mergein3.lst.tlone.Merge.db.7.poli.qual0.Union.V7-1.max.db";
...
#############################################################     DB
$ilst="/path/to/project_inputs/inds_2plot.lst";

#$ilst="/path/to/union_db/inds_2plot.lst";
...
foreach my $cutoff (@cof){
    ...
    #$file = "/path/to/union_db/1.ALL.Merge.2.poli.qual0.Union.V7-1.max.db.gz";
