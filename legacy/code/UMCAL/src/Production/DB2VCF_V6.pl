...
$file="/path/to/workdir/mpilp2db/mpileups.lst.mpileup.db";
$list="/path/to/workdir/mpilp2db/Maize_GBS_Kriztian_build.lst";
$head="/path/to/workdir/mpilp2db/mpileups.lst.tlone";
