...
$bed="/path/to/project_inputs/Zm-B73-REFERENCE-NAM-5.0.chr7.bed";
$ref="/path/to/reference/Zm-B73-REFERENCE-NAM-5.0.fa.OL";
#$file="/path/to/workdir/ALL2/1.ALL.Merge.db.gz.head";
#$file="/path/to/workdir/ALL3/1.ALL.Merge.db.gz";
#$file="/path/to/workdir/ALL3/SUBSET_1.ALL.Merge.db";
$file="/path/to/project_inputs/files.mergein3.lst.tlone.Merge.db";

#$list="/path/to/workdir/ALL3/vcf_tmptx.lst.tlone";
