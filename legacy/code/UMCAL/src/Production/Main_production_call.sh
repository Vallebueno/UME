...
GP="/path/to/legacy/Caronte/code"
PACK="UMCAL/src/Production/"

# === INPUT Config ===

IDIR="/path/to/workdir/mpilp2db"
KEY="/path/to/workdir/mpilp2db/mpileups.lst"
REF="/path/to/reference/Zm-B73-REFERENCE-NAM-5.0.fa.OL"

ODIR="/path/to/workdir/mpilp2db"
#LST="/path/to/project_inputs/files.mergein3.lst.tlone.Merge.db.7.poli.qual0.Union.V7-1.max.db.lst"
LST="/path/to/workdir/mpilp2db/Maize_GBS_Kriztian_build.lst"
