...
$file="/path/to/workdir/Production_ALL_Data_2023_10/Discovery_2023_08_cof10_ALLC_V2.ll";

$GBSf="/path/to/diversity_panels/GBS/Maize_GBS_Kriztian_build.lst";

$out="/path/to/workdir/Production_ALL_Data_2023_10/Discovery_2023_08_cof10_ALLC_V3.ll";
